...
// Contains checks if the IP address exists in Redis
func (r *RedisDataSource) Contains(ctx context.Context, ipAddress string) (bool, error) {
	key := r.keyPrefix + ipAddress
