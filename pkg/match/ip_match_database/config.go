...
func (c *IpMatchDatabaseConfig) ApplyDefaults() {
...
func (c *IpMatchDatabaseConfig) ResolvePaths(resolve func(string) (string, error)) error {
	var fields []*string
...
// of failing.
func (c *IpMatchDatabaseConfig) ValidateWith(opts controller.ValidationOptions) error {
...
func (c *IpMatchDatabaseConfig) GetCacheTTL() time.Duration {
	if c.Cache == nil {
		return 0
	}
